...
export default function CTASection() {
  return (
    <section className="py-24" style={{ background: COLORS.BG, color: COLORS.TEXT }}>
      <div className="mx-auto max-w-5xl px-4 text-center rounded-3xl overflow-hidden"
           style={{
        ...
        <h3 className="text-2xl sm:text-3xl font-black">Bereit für fokussiertes Lernen?</h3>
        <p className="mt-3 text-sm" style={{ color: COLORS.SUBTLE }}>
          Lade ein PDF hoch und erhalte in Minuten eine strukturierte Summary plus Karten.
        </p>
