...
import { HeroDoc, HeroMountain, HeroUpload } from "../CustomSVG";
...
function HeroSection() {
  ...
  return (
    <section className="pt-50 min-h-screen pb-12">
      <div className="flex justify-center">
        <div className="bg-[#c7f022] min-h-[700px] w-[75%] max-w-7xl rounded-xl flex flex-col items-center justify-center text-black px-4">
          <div className="flex flex-wrap gap-16 items-center justify-between">
            <div>
              <h1 className="text-5xl font-extrabold my-6">Edu Pilot</h1>
              <p className="text-2xl max-w-2xl mb-4">
